...
/*
 * This file has been patched to fix issues with keypresses
 * Do not just update it to another version of jquery floatbox!!
*/
(function ($) {
    $.floatbox = function (options) {
        ...
        var init = function () {
            ...
            var keyHandler = function (e) {
                //changes to handle esc Key as it should work in firefox
                var srcKey = $.browser.mozilla ? e.keyCode : e.which;
                var escKey = 27;
                if (srcKey === escKey) {
                    // Unbind all events with floatbox-namespace
                    $(document).unbind(".floatbox")
                    closeBox();
                }
            };
            $(document).bind("keypress.floatbox", keyHandler)
            .bind("keydown.floatbox", keyHandler);
